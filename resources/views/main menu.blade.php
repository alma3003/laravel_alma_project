...
<section id="title">
    <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            ...
                            <div class="dropdown">
                                <a class="nav-link"   href="{{url('/main')}}"
                                   {{config('app.name','main')}} onmouseover="myFunction1()">Main menu</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link"  href="{{url('/info')}}"
                                {{config('app.name','main')}}>Information</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  href="{{url('/login')}}"
                                {{config('app.name','main')}}>Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  href="{{url('/contacts')}}"
                                {{config('app.name','main')}}>Contacts</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <section id="main">
                ...
                <div class="col-lg-6">
                    <div class="slider">
                        <div class="img-box">
                            ...
                            <a class="carousel-control-prev1" href="#carouselSlidesOnly" role="button" data-slide="prev" onclick="previous()">
                                <span class="carousel-control-prev-icon"></span></a>
                            <a class="carousel-control-next1" href="#carouselSlidesOnly" role="button" data-slide="next" onclick="nextimage()">
            ...
            <!--musicContainer-->
            <div class="row">
                <div class="music-container col-md-6 offset-md-3" id="music-container">
                    ...
                    <audio src="Qorqyt ata turaly añyz.mp3" id="audio"></audio>

                    <div class="img-container">
                        <img src="images/all.jpg" alt="audio-cover" id="cover" >
                    </div>

                    <div class="row">
                        <div class="navigation col-sm">
                            <button id="prev" class="action-btn">
                                <i class="fas fa-backward" style="color:black"></i>
                            </button>
                        </div>
                        <div class="navigation col-sm">
                        ...
                        <div class="navigation col-sm">
                            <button id="next" class="action-btn">
                                <i class="fas fa-forward" style="color:black"></i>
                            </button>
                        </div>
                    </div>
                </div>
